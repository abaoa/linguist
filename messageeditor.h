...
public:
    ...
    void setTransText(const QString &text,int index);
    void showTransLogInfo(const QString &text,bool isClear = false);
signals:
    void translationChanged(const QStringList &translations);
    void
    translatorCommentChanged(const QString &comment);
