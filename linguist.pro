QT += core-private gui-private widgets uitools-private printsupport network xml

DEFINES += QT_NO_CAST_FROM_ASCII QT_NO_CAST_TO_ASCII

include($$PWD/shared/formats.pri)
